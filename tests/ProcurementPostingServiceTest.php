...
$svpValidation = $service->validateSvpInput([
    ...
    'posting_date' => '2026-04-10 09:00',
    'bid_submission_deadline' => '2026-04-11 10:00',
...
assertSameValue('2026-04-10 09:00:00', $svpValidation['data']['posting_date'], 'SVP validation should keep the posting date.');
assertSameValue('2026-04-11 10:00:00', $svpValidation['data']['bid_submission_deadline'], 'SVP validation should keep the opening date.');
