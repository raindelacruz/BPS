...
<dl class="detail-grid">
    ...
    <div><dt>Date of posting</dt><dd><?= ViewHelper::escape(!empty($parent['posting_date']) ? date('Y-m-d H:i', strtotime((string) $parent['posting_date'])) : ''); ?></dd></div>
    <div><dt>Opening date</dt><dd><?= ViewHelper::escape(!empty($parent['bid_submission_deadline']) ? date('Y-m-d H:i', strtotime((string) $parent['bid_submission_deadline'])) : ''); ?></dd></div>
