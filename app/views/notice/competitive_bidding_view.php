...
<div class="page-head">
    <div>
        ...
        <p>Competitive Bidding workflow for reference <?= ViewHelper::escape($parent['reference_number']); ?>.</p>
    </div>
...
<dl class="detail-grid">
    ...
    <div><dt>Mode of procurement</dt><dd><?= ViewHelper::escape(ProcurementTypeHelper::label((string) ($parent['procurement_mode'] ?? $parent['mode_of_procurement'] ?? ''))); ?></dd></div>
    ...
    <div><dt>Bid Notice posting date</dt><dd><?= ViewHelper::escape(date('Y-m-d H:i', strtotime((string) $parent['posting_date']))); ?></dd></div>
    <div><dt>Bid submission deadline</dt><dd><?= ViewHelper::escape(date('Y-m-d H:i', strtotime((string) $parent['bid_submission_deadline']))); ?></dd></div>
</dl>

<div class="card-section stack-sm">
    <div class="page-head">
        <div>
            <h2>Competitive Bidding Actions</h2>
            <p><?= ViewHelper::escape($isArchived ? 'Archived records are immutable and remain part of the public historical record.' : 'Only bidding-related actions are available on this workflow page.'); ?></p>
        </div>
...
<div class="card-section stack-sm">
    <div class="page-head"><div><h2>Bidding Documents</h2></div></div>
    <p class="muted" style="margin: -2px 0 4px;">Only bidding-stage documents appear on this page.</p>
